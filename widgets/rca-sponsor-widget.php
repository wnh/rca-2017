...
<?php
    ...
    */
    class rca_sponsors_widget extends WP_Widget {

        function __construct() {
            parent::__construct(false, $name = __( 'RCA Custom Sponsors', 'wp-sponsors' ), array( 'description' => __('List your sponsors, per category, with or without images', 'wp-sponsors')));
        }



        private function getImage($post_ID) {
            $post_thumbnail = get_the_post_thumbnail( $post_ID, array(300, 200));
            ...
            if ($post_thumbnail && !empty($post_thumbnail)) {
                ...
                return '<img itsthething="true" src="' . $post_custom_image . '" height="80px"/>';
            }
        }
        ...
        // end class rca_sponsors_widget
        add_action('widgets_init', create_function('', 'return register_widget("rca_sponsors_widget");'));
